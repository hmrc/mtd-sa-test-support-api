...
class RestoreCheckpointValidatorSpec extends UnitSpec {

  private val validator = new RestoreCheckpointValidator

  private val validCheckpointId   = "a1e8057e-fbbc-47a8-a8b4-78d9f015c253"
  private val invalidCheckpointId = "some_invalid_id"

  private val validRawData   = RestoreCheckpointRawData("some_id", validCheckpointId)
  private val invalidRawData = RestoreCheckpointRawData("some_id", invalidCheckpointId)

  "RestoreCheckpointValidator" when {
