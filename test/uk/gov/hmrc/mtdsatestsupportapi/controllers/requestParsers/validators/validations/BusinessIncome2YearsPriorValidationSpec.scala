  ...
  "BusinessIncome2YearsPriorValidation" must {
    ...
    "return an error" when {
      "invalid value is provided" in {
        BusinessIncome2YearsPriorValidation.validateOptional(Some(-1000), path = "/businessIncome2YearsPrior") shouldBe List(
          error.withExtraPath("/businessIncome2YearsPrior"))
      }
    }
  }
