...
trait MockDeleteCheckpointRequestParser extends MockFactory {
  ...
  object MockDeleteCheckpointRequestParser {

    def parseRequest(data: DeleteCheckpointRawData): CallHandler[Either[ErrorWrapper, DeleteCheckpointRequest]] =
      (mockDeleteCheckpointRequestParser
        .parseRequest(_: DeleteCheckpointRawData)(_: String))
        .expects(data, *)
