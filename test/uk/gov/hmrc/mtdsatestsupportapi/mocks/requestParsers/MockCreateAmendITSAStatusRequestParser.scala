...
trait MockCreateAmendITSAStatusRequestParser extends TestSuite with MockFactory {
  ...
  object MockCreateAmendITSAStatusRequestParser {

    def parseRequest(data: CreateAmendITSAStatusRawData): CallHandler[Either[ErrorWrapper, CreateAmendITSAStatusRequest]] =
      (mockRequestParser
        .parseRequest(_: CreateAmendITSAStatusRawData)(_: String))
        .expects(data, *)
