...
trait MockRestoreCheckpointConnector extends TestSuite with MockFactory {
  ...
  object MockRestoreCheckpointConnector {

    def restoreCheckpoint(requestData: RestoreCheckpointRequest): CallHandler[Future[DownstreamOutcome[Unit]]] =
      (mockRestoreCheckpointConnector
        .restoreCheckpoint(_: RestoreCheckpointRequest)(
          _: ExecutionContext,
          _: HeaderCarrier,
          _: String
        ))
